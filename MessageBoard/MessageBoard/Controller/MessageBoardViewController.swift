...
class MessageBoardViewController: UIViewController {
    ...
    @IBAction func sendBtnClicked(_ sender: Any) {
        ...
        if isUpData == true{
            ...
            LocalDatabase.DataUao.updateData(message: messageArray[upDataIndex])
            ...
            LocalDatabase.DataUao.addData(message: msg)
...
//            self.deleteMessage(message: deleteMessage!)
            LocalDatabase.DataUao.deleteData(message: self.messageArray[indexPath.row])
